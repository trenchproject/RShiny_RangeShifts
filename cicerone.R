guide <- Cicerone$
  ...
  el = "plot-wrapper",
  title = "Plot",
  description = HTML("The plot shows the climate velocity of populations' thermal envelope against the observed shift of populations.<br><br>
                       The <b>purple line</b> represent a 1-to-1 line, which tells you if the population is shifting more or less compared to the thermal envelope.")
)$
  step(
  el = "switch-wrapper",
  title = "Latitude/Depth",
  description = "This button toggles between two plots that show different directions of the shifts. Greater values correspond to further north in the latitude plot and deeper in the depth plot.<br><br>
   Keep it at <b>Latitude</b> for now."
)$
  step(
  el = "plot-wrapper",
  title = "Plot details",
  ...
  description = HTML("This tells you which taxa from which region are plotted.<br>
                       Let's see how <b>Fish</b> are doing in the <b>Aleutians</b> region. <br><br>
                       1) Select <b>Fish</b> under taxa.<br>
                       2) Select <b>Aleutians</b> from regions."),
  position = "top"
)$
  step(
  el = "plot-wrapper",
